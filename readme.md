...
> 📝 **Código-fonte:** O script completo está disponível no diretório [`app_script/organizador_drive.js`](./app_script/organizador_drive.js).

### 🛠️ Como Instalar no Google Sheets:
1. Abra a planilha vinculada ao Google Forms.
2. Acesse **Extensões > Apps Script**.
3. Cole o código de [`organizador_drive.js`](./app_script/organizador_drive.js) e defina o `idPastaContrato`.
